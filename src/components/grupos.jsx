...
const agregarPersonaje = async (idgrupo, idpersonaje) => {
  ...
  const eliminarGrupoDeBBDD = async (idgrupo) => {
    try {
      ...
      const response = await axios.delete(`https://zepiro.onrender.com/delete-grupo/${idgrupo}`);
...
const guardarCambiosBBDD = async (idgrupo, idspersonajes) => {
  try {
    ...
    const response = await axios.put(`https://zepiro.onrender.com/update-grupos`, {
      idgrupo,
      idspersonajes
    }, {
      headers: {
