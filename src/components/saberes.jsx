...
export const Saberes = ({ saberes, setSaberes }) => {
  ...
  const insertSaber = async () => {
    ...
    try {
        ...
        const response = await axios.post('https://zepiro.onrender.com/insertSaber', nuevoSaber, {
        headers: {
  ...
  const updateSaber = async () => {
    ...
    try {
        ...
        const response = await axios.put('https://zepiro.onrender.com/updateSaber', updatedSaber, {
        headers: {
          'Content-Type': 'application/json',
        },
      });
  ...
  const deleteSaber = async (id) => {
    ...
    try {
      const response = await axios.delete(`https://zepiro.onrender.com/deleteSaber/${id}`);
