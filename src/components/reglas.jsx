    ...
    <>
      <Offcanvas show={show} onHide={handleClose} placement="top">
       ...
       <div className="cuadros lumina">
        <Button style={{border:"2px solid red", color:"yellow", borderRadius:"10px", textAlign:"center",fontSize:"1em",padding:"5px",backgroundColor:"black", display:"flex", alignItems:"center",justifyContent: "center"}} onClick={()=>handleShow(reglas.accion.titulo,reglas.accion.info)}>
        <img
          alt=""
          src="/acciones.svg"
          width="30"
     ...
     <div className="reglas4columnas" style={{padding:"1em", fontSize:"0.8em"}}>
        ...
        <div className="cuadros lumina">
        <Button style={{border:"2px solid red", color:"yellow", borderRadius:"10px", textAlign:"center",fontSize:"1em",padding:"5px",backgroundColor:"black", display:"flex", alignItems:"center", justifyContent: "center"}} onClick={()=>handleShow(reglas.salud.titulo,reglas.salud.info)}>
        <img
          alt=""
          src="/salud.svg"
          width="30"
        ...
        <div className="cuadros lumina">
        <Button style={{border:"2px solid red", color:"yellow", borderRadius:"10px", textAlign:"center",fontSize:"1em",padding:"5px",backgroundColor:"black", display:"flex", alignItems:"center", justifyContent: "center"}} onClick={()=>handleShow(reglas.incremento.titulo,reglas.incremento.info)}>
        <img
          alt=""
          src="/incremento.svg"
          width="30"
        ...
        <div className="cuadros lumina">
        <Button style={{border:"2px solid red", color:"yellow", borderRadius:"10px", textAlign:"center",fontSize:"1em",padding:"5px",backgroundColor:"black", display:"flex", alignItems:"center", justifyContent: "center"}} onClick={()=>handleShow(reglas.campo.titulo,reglas.campo.info)}>
        <img
          alt=""
          src="/campo.svg"
          width="30"
     ...
     <div className="cuadros lumina">
        <Button style={{border:"2px solid red", color:"yellow", borderRadius:"10px", textAlign:"center",fontSize:"1em",padding:"5px",backgroundColor:"black", display:"flex", alignItems:"center", justifyContent: "center"}} onClick={()=>handleShow(reglas.ken.titulo,reglas.ken.info)}>
        <img
          alt=""
          src="/ken.svg"
          width="30"
        ...
        <Button style={{border:"2px solid red", color:"yellow", borderRadius:"10px", textAlign:"center",fontSize:"1em",padding:"5px",backgroundColor:"black", display:"flex", alignItems:"center", justifyContent: "center"}} onClick={()=>handleShow(reglas.estudio.titulo,reglas.estudio.info)}>
        <img
          alt=""
          src="/estudio.svg"
          width="30"
      ...
      <div className='reglas1Columnas' style={{padding:"1em",fontSize:"0.8em"}}>
       <div className="cuadros lumina">
        <Button style={{border:"2px solid red", color:"yellow", borderRadius:"10px", textAlign:"center",fontSize:"1em",padding:"5px",backgroundColor:"black", display:"flex", alignItems:"center", justifyContent: "center"}} onClick={()=>handleShow(reglas.herbolaria.titulo,reglas.herbolaria.info)}>
        <img
          alt=""
          src="/herbolaria.svg"
          width="30"
